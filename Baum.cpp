...
struct Cluster
{
    ...
    /*
    =====================================================
    Zählt die von diesem Cluster sichtbaren Cluster
    =====================================================*/
    ...
    /*
    =====================================================
    Zeichnet alle von diesem aus sichtbaren Cluster
    =====================================================*/
    ...
    /*
    =======================================================
    Sucht alle Polygone,die sich in diesem Cluster befinden
    =======================================================*/
...
/*
===================================================================
=            Zeichnet alle sichtbaren Cluster (Kernstück)         =
===================================================================*/
void RenderVisibleClusters(void)
{
    ...
    else
    {
        ...
        else ::RenderAllClusters(); // Work-Around: bei sehr,sehr wenigen Clustern beträgt die Sichtbarkeit 0!?
    }
...
/*
=====================================================================================
Gibt Index auf richtigen Brush zurück
=====================================================================================*/
...
const char* GetCollisionDetetctionString(void)
{
    ...
    else sprintf(buffer,"Collision Detection disabled");
    return buffer;
}

/*
=====================================================================================
Überprüft,ob es eine Kollision der Kaerma-AABB mit einer der Brushes im Level gibt
=====================================================================================*/
...
/*
======================================================================================
Überprüft,ob Kamera-AABB die Wände des Levels schneiden schneiden
=======================================================================================*/
...
/*
======================================================================================
Kernstück der Wandkollisonserkennung:
Überprüft,ob Kamera-AABB die Wände des Levels schneiden schneiden WÜRDEN,wenn die
Kamera um den angegeben Vektor verschoben werden würde.
=======================================================================================*/
