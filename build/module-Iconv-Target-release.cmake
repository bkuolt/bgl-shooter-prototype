...
conan_package_library_targets("${libiconv_LIBS_RELEASE}"    # libraries
                              ...
                              "${libiconv_BIN_DIRS_RELEASE}" # package_bindir
                              "${libiconv_LIBRARY_TYPE_RELEASE}"
                              "${libiconv_IS_HOST_WINDOWS_RELEASE}"
                              libiconv_DEPS_TARGET
                              libiconv_LIBRARIES_TARGETS  # out_libraries_targets
                              "_RELEASE"
                              "libiconv"    # package_name
                              "${libiconv_NO_SONAME_MODE_RELEASE}")  # soname
...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET Iconv::Iconv
                 ...
                 $<$<CONFIG:Release>:${libiconv_LINKER_FLAGS_RELEASE}>)
    set_property(TARGET Iconv::Iconv
                 APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${libiconv_INCLUDE_DIRS_RELEASE}>)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET Iconv::Iconv
                 APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${libiconv_LIB_DIRS_RELEASE}>)
    set_property(TARGET Iconv::Iconv
                 APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${libiconv_COMPILE_DEFINITIONS_RELEASE}>)
    set_property(TARGET Iconv::Iconv
                 APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${libiconv_COMPILE_OPTIONS_RELEASE}>)
