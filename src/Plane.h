...
class Plane {
	...
	public:
		...
		/**
		 * @brief �berpr�ft,ob Ebene von Strahl geschnitten wird. Die Reichweite des Strahls wird
		...
		/**
		 * @brief Berechnet die Parameter der Ebenengleichung f�r angegebenen Punkt (perp dot product)
		 */
