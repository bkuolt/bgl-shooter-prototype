...
CoordinateSystem::CoordinateSystem(const Vector &x, const Vector &y,
                                   const Vector &z) {
  axes[X] = x;
  axes[Y] = y;
  axes[Z] = z;
...
const Vector &CoordinateSystem::getAxis(Axis axis) const { return axes[axis]; }

const Vector &CoordinateSystem::getOrigin(void) const { return origin; }

void CoordinateSystem::setOrigin(const Vector &v) { origin = v; }
