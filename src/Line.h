...
class Ray : public Line {
 ...
 public:
	...
	/**
	 * @brief Überprüft,ob Punkt auf dem Strahl liegt  mit Berücksichtigung der Reichweite) 
	 */
	bool contains(const Vector &P) const {
	...
	/**
	 * @brief Berechnet die Strecke zwischen Ursprung der Geraden und dem angegbenen
